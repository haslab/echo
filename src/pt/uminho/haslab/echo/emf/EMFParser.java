...
public class EMFParser {
	...
	private ResourceSet load_resourceSet = new ResourceSetImpl();
	...
	public EMFParser(){
		...
		load_resourceSet.getLoadOptions().put(XMLResource.OPTION_EXTENDED_META_DATA, extendedMetaData);
	...
	public EObject loadObject(String argURI, String var) {
		...
		Resource load_resource = load_resourceSet.getResource(URI.createURI(argURI), true);
	...
	public EPackage loadPackage(String uri)
	{
		...
		load_resourceSet.getPackageRegistry().put(res.getNsURI(),res);
